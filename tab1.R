      ...
      doc <- tags$html(
        tags$body(
          ...
          tags$ul(
            ...
            tags$li(p("The occurrence of a negative sign in the re-constructed matrix which differs from the original TDM is explained in",
          ...
          tags$ul(
            ...
            tags$li(p("There are many great image compressions tutorials using R. Two I found very useful and inspired this app
                    are, ", 
            ...
            tags$li(p("Finding the 'knee' of the scree plot uses the inflection R package and the Unit Invariant Knee method described in ",
            ...
            shiny::a("Introduction to Latent Semantic Analysis",
                     ...
                     target="_blank"), " which itself takes the text example from the canonical Deerwester 1990 paper",
